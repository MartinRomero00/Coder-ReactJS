  ...
  return (
    <header>
      <ul className='grid grid-cols-3 place-items-center mt-2'>
        <li className='flex justify-center'><img src={logo} alt="logo" width={60}/><h1 className='text-4xl mt-3 ml-1 font-bold text-orange-400 titulo underline decoration-pink-500 font-mono'>Tecno <span className='text-3xl font-bold text-orange-400 '>Facts</span></h1></li>
